...
function betterFind(haystack, needle) {
  ...
  if (haystack.indexOf(needle) < index) {
      let newArr = haystack.slice(0, index)
      betterFind(newArr, needle)
      console.log(needle + "should be less than")
  } else if (haystack.indexOf(needle) > index) {
      let newArr = haystack.slice(index, (haystack.length))
      betterFind(newArr, needle)
      console.log(needle + "should be greater than");

  } else if (haystack.indexOf(needle) == index) {
      console.log("your needle is at position " + index);
  }
...
// function betterFind(haystack, needle) {
  ...
  // } else if (needle == haystack[index]) {
  //     console.log("your needle is at position" + needle);
  // }
